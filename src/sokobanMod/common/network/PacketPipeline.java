...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    public void initialise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("sokoban", this);
        registerPackets();
    }
    ...
    {
    	registerPacket(LocationDoublePacket.class);
    	registerPacket(LocationIntPacket.class);
    	registerPacket(PacketAddChatMessage.class);
    	registerPacket(PacketGiveLevelAchievement.class);
