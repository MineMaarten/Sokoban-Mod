...
public class TutorialLevel5Gen implements ISokobanLevel{
    private static final int[] levelBounds = {7, 12, 11};
    private static final int[] entranceCoords = {2, 1, 11, 2, 2, 11};
