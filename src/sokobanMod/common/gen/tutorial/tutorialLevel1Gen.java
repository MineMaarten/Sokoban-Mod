...
public class TutorialLevel1Gen implements ISokobanLevel{
    private static final int[] levelBounds = {8, 6, 9};
    private static final int[] entranceCoords = {6, 6, 0, 7, 6, 0, 8, 6, 0, 6, 3, 0, 6, 5, 0, 7, 2, 0, 7, 3, 0, 7, 4, 0, 7, 5, 0, 8, 1, 0, 8, 2, 0, 8, 3, 0, 8, 4, 0, 8, 5, 0};
