...
public class tutorialLevel2Gen{
    public static final int levelNumber = 1;
    ...
    public static boolean generate(World world, int generationMethod, int baseX, int baseY, int baseZ){
        ...
        int flatY = levelGenBase.canGenerateHereAndClear(world, generationMethod, entranceCoords, baseX, baseY, baseZ, baseX + 4, baseY + 8, baseZ + 10);
