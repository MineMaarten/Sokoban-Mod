...
public class easyLevel1Gen{
    ...
    public static boolean generate(World world, int generationMethod, int baseX, int baseY, int baseZ){
        ...
        int flatY = levelGenBase.canGenerateHereAndClear(world, generationMethod, entranceCoords, baseX, baseY, baseZ, baseX + 18, baseY + 8, baseZ + 22);
