...
public class EasyLevel5Gen implements ISokobanLevel{
    private static final int[] levelBounds = {14, 9, 11};
    private static final int[] entranceCoords = {12, 6, 11, 12, 7, 11};
