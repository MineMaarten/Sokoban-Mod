...
public class hardLevel1Gen{
    public static final int levelNumber = 3000;
    public static final int[] levelBounds = {19, 12, 15};
    public static final int[] entranceCoords = {10, 10, 15, 10, 11, 15, 11, 10, 15, 11, 11, 15, 16, 1, 15, 16, 2, 15, 16, 3, 15, 17, 1, 15, 17, 2, 15, 17, 3, 15, 0, 10, 5, 19, 10, 5, 0, 10, 6, 19, 10, 6, 0, 11, 5, 19, 11, 5, 0, 11, 6, 19, 11, 6};
    ...
    public static boolean generate(World world, int generationMethod, int baseX, int baseY, int baseZ){
        ...
        int flatY = levelGenBase.canGenerateHereAndClear(world, generationMethod, entranceCoords, baseX, baseY, baseZ, baseX + 19, baseY + 12, baseZ + 15);
